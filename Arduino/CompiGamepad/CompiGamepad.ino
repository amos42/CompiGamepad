...
#define USES_CMD_SHELL      (OFF)
#define USES_BATTERY_CHECK  (OFF)
#define USES_BUTTON_L2R2    (OFF)
//======================================
...
#define REAL_BUTTON_COUNT   (BUTTON_COUNT + L2R2_BUTTON_COUNT)

#if EXTRA_KEY_MODE == EXTRA_KEY_MODE_FN
#define VIRTU_BUTTON_COUNT      (ARROW_COUNT + REAL_BUTTON_COUNT * 2)
#else
